...
import { IconArrow, IconBack, IconCheck, IconChevronRight, IconFlame, IconSparkle, IconWarning } from "@/components/icons";
...
export default function WeeklyReview({ digest, onPrevWeek, onNextWeek, canGoNext }: WeeklyReviewProps) {
  ...
  return (
    <>
      ...
      {/* AIコーチのコメント(Issue #12)。生成はユーザーの明示操作でのみ行い、生成済みの週はキャッシュを表示する */}
      <Card sx={{ p: "18px" }}>
